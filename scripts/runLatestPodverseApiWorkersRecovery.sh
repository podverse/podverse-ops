...
/usr/local/bin/docker-compose -f "/home/mitch/podverse-ops/docker-compose.${1}.worker.yml" run -d --name podverse_api_parser_worker_11 podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 360000
/usr/local/bin/docker-compose -f "/home/mitch/podverse-ops/docker-compose.${1}.worker.yml" run -d --name podverse_api_parser_worker_12 podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 360000
