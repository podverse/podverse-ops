...
/usr/local/bin/docker-compose -f /home/mitch/podverse-ops/docker-compose.$1.yml run -d --name podverse_api_parser_worker_priority_9 podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 150000 priority
/usr/local/bin/docker-compose -f /home/mitch/podverse-ops/docker-compose.$1.yml run -d --name podverse_api_parser_worker_priority_10 podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 150000 priority
/usr/local/bin/docker-compose -f /home/mitch/podverse-ops/docker-compose.$1.yml run -d --name podverse_api_parser_worker_priority_11 podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 150000 priority
/usr/local/bin/docker-compose -f /home/mitch/podverse-ops/docker-compose.$1.yml run -d --name podverse_api_parser_worker_priority_12 podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 150000 priority
