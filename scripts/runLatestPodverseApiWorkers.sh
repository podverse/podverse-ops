...
docker-compose -f /home/mitch/podverse-ops/docker-compose.$1.yml run -d --name podverse_api_parser_worker_1e podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 1 360000
docker-compose -f /home/mitch/podverse-ops/docker-compose.$1.yml run -d --name podverse_api_parser_worker_1d podverse_api_parser_worker npm run scripts:parseFeedUrlsFromQueue -- 1 360000
